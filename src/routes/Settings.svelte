<script>
  ...
  const SECTION_KEYWORDS = {
    ...
    connectedServices: ['food sources','connected services','usda','open food facts','mealie','cooktrace','recipe','recipes','pull','import','search language','country','api key','credentials','username','password','bearer','token'],
