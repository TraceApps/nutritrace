<script>
  ...
  const SECTION_KEYWORDS = {
    ...
    sharing:           ['sharing','share','group','catalogue','catalog','visibility','private','members','food sharing','default visibility','default sharing','new items','new foods','new meals','new recipes','auto share','automatic sharing'],
