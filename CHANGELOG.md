...
- **MCP date-range reads.** Read diary entries, daily totals, recent foods, and recent meals over inclusive arbitrary `start`/`end` date bounds; the existing single-day tools and defaults are unchanged.
