/**
 * /api/v1/steps — persisted daily step observations from wellness data.
 * Same xCore() the MCP get_steps tool calls. See diary.js in this same
...
import { getStepsCore } from '../../../lib/mcp/tools/get-steps.js';
